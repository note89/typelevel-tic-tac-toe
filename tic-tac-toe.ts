...
type CartesianProductString2<T extends ToStringableTypes,T2 extends ToStringableTypes > = `${T},${T2}`;
...
type GetBoardOfSize<Size extends number> = FromToInc<1, Size>

type Size = 3
type Column2 = FromToInc<1,Size>
type Row2    = FromToInc<1,Size>
type Position2 = CartesianProductString2<Column2[number], Row2[number]>
...
type Diagonals<Size extends number> = Zip<FromTo<1, Size>, FromTo<1,Size>> | Zip<FromTo<1, Size>, FromTo<1,Size>>

type A9 = Zip<[1,2], [1,2]>

type Diag = Diagonals<3>
...
type Position = CartesianProductString<Row,Column>;


type Squares = { [s in Position]: Square };


type GetRowPositions<R extends Row> = CartesianProductString<R,Column>;
type GetColumnPositions<C extends Column> = CartesianProductString<Row,C>;

type WinningPositions =
  // Rows
  | [GetRowPositions<"Top">]
  | [GetRowPositions<"Middle">]
  | [GetRowPositions<"Bottom">]
  // Columns
  | [GetColumnPositions<"Left">]
  | [GetColumnPositions<"Middle">]
  | [GetColumnPositions<"Right">]
  // Diagonals
...
// prettier-ignore
// @ts-expect-error
type NoDoubleMove = Move<Move<InitialBoard, Cross, "TopRight">, Cross, "TopLeft" >;

// No start with Circle
// @ts-expect-error
type NoStartWithCircle = Move<InitialBoard, Circle, "TopRight">;

// No taking a used square
// prettier-ignore
// @ts-expect-error
type NoTakingAUsedSquare = Move<Move<InitialBoard, Cross, "TopRight">,Circle, "TopRight">

// Don't take to many moves back
// @ts-expect-error
type NotToManyMovesBack = TakeMoveBack<InitialBoard>;

type MoveOne = Move<InitialBoard, Cross, "TopRight">;
...
type Test = Expect<
  Equal<IsPositionOccupied<WinCrossFinal, "MiddleLeft">, false>
>;
type Test2 = Expect<Equal<IsPositionOccupied<WinCrossFinal, "TopRight">, true>>;
type Test3 = Expect<Equal<IsPositionOccupied<InitialBoard, "TopRight">, false>>;
// @ts-expect-error
type Test4 = Expect<Equal<IsPositionOccupied<InitialBoard, "TopRight">, true>>;

// DRAW GAME

type DrawStep1 = Move<InitialBoard, Cross, "TopLeft">;
type DrawStep2 = Move<DrawStep1, Circle, "TopMiddle">;
type DrawStep3 = Move<DrawStep2, Cross, "TopRight">;
type DrawStep4 = Move<DrawStep3, Circle, "MiddleLeft">;
type DrawStep5 = Move<DrawStep4, Cross, "MiddleMiddle">;
type DrawStep6 = Move<DrawStep5, Circle, "BottomLeft">;
type DrawStep7 = Move<DrawStep6, Cross, "MiddleRight">;
type DrawStep8 = Move<DrawStep7, Circle, "BottomRight">;
type DrawFinal = Move<DrawStep8, Cross, "BottomMiddle">;

type DrawOutcome = Expect<Draw<any> extends DrawFinal ? true : false>;

// Cross Win
type WinCrossStep1 = Move<InitialBoard, Cross, "TopLeft">;
type WinCrossStep2 = Move<WinCrossStep1, Circle, "BottomLeft">;
type WinCrossStep3 = Move<WinCrossStep2, Cross, "TopRight">;
type WinCrossStep4 = Move<WinCrossStep3, Circle, "BottomMiddle">;
type WinCrossFinal = Move<WinCrossStep4, Cross, "TopMiddle">;
...
// Circle Win
type WinCircleStep1 = Move<InitialBoard, Cross, "TopLeft">;
type WinCircleStep2 = Move<WinCircleStep1, Circle, "BottomLeft">;
type WinCircleStep3 = Move<WinCircleStep2, Cross, "TopRight">;
type WinCircleStep4 = Move<WinCircleStep3, Circle, "BottomMiddle">;
type WinCircleStep5 = Move<WinCircleStep4, Cross, "MiddleMiddle">;
type WinCircleFinal = Move<WinCircleStep5, Circle, "BottomRight">;
